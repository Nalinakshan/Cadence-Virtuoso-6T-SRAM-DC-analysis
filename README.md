...
* **Cell Architecture:** * **Pull-Up PMOS (PM0, PM1):** W = 120nm, L = 45nm
  * **Pull-Down NMOS (NM0, NM1):** W = 120nm, L = 45nm
  * **Access NMOS (NM2, NM3):** W = 120nm, L = 45nm

### Schematic Capture
The schematic was captured using Cadence Virtuoso Schematic Editor. An independent DC voltage source (V4) was tied to the internal node `Qb` to perform a precise voltage sweep for stability characterization.
